...
public class ArgumentArrayAttrImpl extends XMLAttrImpl implements
	 ...
	 */
	protected ArgumentArrayAttrImpl(Element ownerEl, QName attrType,
	...
	private QName convertQName(Element ownerEl, String qnameStr)
			throws WSDLException {

		QName qname = null;

		try {
			qname = DOMUtils.getQName(qnameStr, ownerEl);
